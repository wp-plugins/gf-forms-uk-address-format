<?php
/*
Plugin Name: GF Forms - UK address format
Plugin URI: 
Description: Adds UK post code and county to gravity form dropdown
...
spl_autoload_register('GfUk::autoload');
/**
...
class GfUk
{
    ...
    const TEXT_DOMAIN         = 'gf-uk-postcode-county';
    const OPTION_KEY          = 'gf_uk_postcode_county_rev3a';
    const FILE                = __FILE__;
...
add_action('plugins_loaded', array('GfUk', 'getInstance'));
